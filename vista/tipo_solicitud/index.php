...
<body>
			...
			<div class='contenedor'>
				...
				<a href='../../controlador/ctr_tiposol.php?list=2' class='btn btn-delete'>
					<i></i>
					<span>Inactivos</span>
				</a>
				<?php } ?>
				<a href='../../controlador/ctr_tiposol.php?sql=r' class='btn btn_imprimir' target='blank' style='margin-left: 3px;'>
					<i></i>
					<span>Reporte</span>
				</a>	
								...
								<tbody>
									...
									?>
										<tr>
											...
											<td>
												<a onclick="javascript:return confirm('¿Seguro de eliminar este registro?');" href="../../controlador/ctr_tiposol.php?sql=e&id=<?php echo $r->id; ?>" class='btn btn-delete pull-right'>Eliminar</span>
												<a href="../../controlador/ctr_tiposol.php?sql=m&id=<?php echo $r->id; ?>" class='btn btn-primary pull-right'>
													Editar
												</a>
											</td>
										</tr>
