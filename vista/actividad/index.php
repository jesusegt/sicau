...
<!-- MODAL -->
	...
	<div id="dialog" class="window">
		<form name='formulario' class='formulario' onsubmit='return validarreporte(this)' method='post' action='../../controlador/ctr_actividad.php' target='blank' id='form'>
...
<!-- CONTENIDO PÁGINA -->
		<div class='contenedor'>
			...
			<a href='#dialog' class='btn btn_imprimir' name='modal'>
				<i></i>
				<span>Reporte</span>
			</a>
		</div>
