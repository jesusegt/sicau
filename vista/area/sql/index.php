				...
				<form name='formulario' class='formulario' onsubmit='return validararea(this)' method='post' action='../../../controlador/ctr_area.php'>
					<div class='panel-body'>
						<div class='form-group'>
							...
							<input type='text' class='form-control' name='nombre' placeholder='...' value='' autocomplete='off'  id='miInput' maxlength='25' onkeypress='return soloAlfanumerico(event)' onkeyup='mayusculainicial(this)'>
						</div>
			...
			<div class='panel panel-bordered'>
				<form name='formulario' class='formulario' onsubmit='return validararea(this)' method='post' action='../../../controlador/ctr_area.php'>
					<div class='panel-body'>
						...
						<div class='form-group'>
							<label for='nombre'>Nombre</label>
							<input type='text' class='form-control' name='nombre' placeholder='...' value='<?php echo "$nombre"; ?>' autocomplete='off' id='miInput' maxlength='25' onkeypress='return soloAlfanumerico(event)' onkeyup='mayusculainicial(this)'>
						</div>
