...
<html>
	...
	<body>
		...
		<div class='contenedor'>
			...
			<a href='../../../controlador/ctr_cargo.php?list=1' class='btn btn-warning'>
				<i></i>
		...
		<div class='contenedor'>
			<div class='panel panel-bordered'>
				<form name='formulario' class='formulario' onsubmit='return validarcargo(this)' method='post' action='../../../controlador/ctr_cargo.php'>
					<div class='panel-body'>
						<div class='form-group'>
							<label for='nombre'>Nombre</label>
							<input type='text' class='form-control' name='nombre' placeholder='...' value='' autocomplete='off' onkeypress='return soloAlfanumerico(event)' onkeyup='mayusculainicial(this)' id='miInput' maxlength='25'>
						</div>
					</div>
		...
		<div class='contenedor'>
			<div class='panel panel-bordered'>
				<form name='formulario' class='formulario' onsubmit='return validarcargo(this)' method='post' action='../../../controlador/ctr_cargo.php'>
					<div class='panel-body'>
						<div class='form-group'>
							<input type='text' class='form-control' name='id' placeholder='...' value='<?php echo"$id"; ?>' autocomplete='off' maxlength='10' style='display: none;'>
						</div>
						<div class='form-group'>
							<label for='nombre'>Nombre</label>
							<input type='text' class='form-control' name='nombre' placeholder='...' value='<?php echo"$nombre"; ?>' autocomplete='off' onkeypress='return soloAlfanumerico(event)' onkeyup='mayusculainicial(this)' maxlength='25' id='miInput' >
						</div>
					</div>
...
<body>
		...
		<div class='contenedor'>
			<h1 class='page-title'>
				<i></i>
				Cargo <span style='color:red;'>INACTIVOS</span>
			</h1>
			<a href='../../../controlador/ctr_cargo.php?list=1' class='btn btn-warning'>
				<i></i>
				<span>Volver</span>
							...
							<tbody>
								...
								?>
									<tr>
										...
										<td>
											<a onclick="javascript:return confirm('¿Seguro que quiere habilitar este registro?');" href="../../../controlador/ctr_cargo.php?sql=h&id=<?php echo $r->id; ?>" class='btn btn-add-new pull-right'>Habilitar</a>
										</td>
									</tr>
								<?php endforeach; 
									}
